## Utility tools for handling language-specific plurals and ordinal numbers (first, second etc.).
##
## Contains methods for handling language-specific plurals and ordinal numbers (first, second etc.).
## See rules by Unicode (probably, because that's what YarnSpinner uses):
...
func get_plural_case_string(pcase: int) -> String:
...
## Gets the cardinal plural case of the given value depending on the given locale.
...
## "en", "ast", "ca", "de", "et", "fi", "fy", "gl",
## "ia", "io", "it", "ji", "nl", "sc", "scn", "sv",
## "sw", "ur", "yi"
...
## "af", "an", "asa", "az", "bem", "bez", "bg",
## "brx", "ce", "cgg", "chr", "ckb", "dv", "ee",
## "el", "eo", "es", "eu", "fo", "fur", "gsw", "ha",
## "haw", "hu", "jgo", "jmc", "ka", "kaj", "kcg",
## "kk", "kkj", "kl", "ks", "ksb", "ku", "ky", "lb",
## "lg", "mas", "mgo", "ml", "mn", "mr", "nah", "nb",
## "nd", "ne", "nn", "nnh", "no", "nr", "ny", "nyn",
## "om", "or", "os", "pap", "ps", "rm", "rof", "rwk",
## "saq", "sd", "sdh", "seh", "sn", "so", "sq", "ss",
## "ssy", "st", "syr", "ta", "te", "teo", "tig", "tk",
## "tn", "tr", "ts", "ug", "uz", "ve", "vo", "vun",
## "wae", "xh", "xog"
...
## Gets the ordinal plural case of the given value depending on the given locale.
## The returned value is an item of the enum PluralCase.
## Returns PluralCase.NoPluralisation if the locale isn't recognised.
...
## "gl", "gsw", "he", "hr", "hsb", "ia", "id", "in",
## "is", "iw", "ja", "km", "kn", "ko", "ky", "lt", "lv",
## "ml", "mn", "my", "nb", "nl", "pa", "pl", "prg", "ps",
## "pt", "root", "ru", "sd", "sh", "si", "sk", "sl", "sr",
## "sw", "ta", "te", "th", "tr", "ur", "uz", "yue", "zh",
## "zu"
...
## Example: get_fraction(5.67)     -> 67
##          get_fraction(0.00005)  -> 5
func get_fraction(value: float) -> int:
	var e: int = step_decimals(value)
